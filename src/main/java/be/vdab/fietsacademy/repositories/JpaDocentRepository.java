...
public class JpaDocentRepository implements DocentRepository {
    ...
    public List<Docent> findByWeddeBetween(BigDecimal van, BigDecimal tot) {
        ...
        ).setParameter("van", van).setParameter("tot", tot).setHint("javax.persistence.loadgraph", manager.createEntityGraph(Docent.MET_CAMPUS)).getResultList();
    }
    ...
    public List<AantalDocentenPerWedde> findAantalDocentenPerWedde() {
        return manager.createQuery("select new be.vdab.fietsacademy.queryresults.AantalDocentenPerWedde" +
